...
class LidarObstacleDetector(Node):
    def __init__(self):
        ...
        # Publisher for danger flag
        self.danger_pub = self.create_publisher(Bool, '/danger_flag', 10)
        ...
        self.safety_radius = 1       # meters, minimum safe distance
    ...
    def lidar_callback(self, msg: LaserScan):
        ...
        # Publish danger flag
        msg_flag = Bool()
        msg_flag.data = danger_detected
        self.danger_pub.publish(msg_flag)
